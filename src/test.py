...
print "most liked jam was: %s, jammed by %s on %s (%s)" % (most_popular_jam,most_popular_jam.get_user(),most_popular_jam.get_creation_date(), most_popular_jam.get_url())